                            ...
                            <div className='hidden md:block'>
                                <table className={"text-sm text-left text-gray-8000 dark:text-gray-400 rounded-lg"}>
                                    ...
                                    <tr className={"bg-white border-b dark:bg-gray-900 dark:border-gray-700"}>
                                        <th scope={"row"}
                                            className={"px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"}>{dates[0]}</th>
                                        <td
                                            ...
                                            {description[0] === "sky is clear" &&
                                                ...
                                                <Image src={heavyrain}
                                                       alt='rain-cloud-icon'/> || description[0] === "overcast clouds" &&
                                                <Image src={cloud}
                                                       alt="cloud-sun"/> || description[0] === "broken clouds" &&
                                                <Image src={midcloud}
                                                       alt="cloud-sun"/> || description[0] === "scattered clouds" &&
                                                <Image src={fewcloud} alt="sun"/> || description[0] === "few clouds" &&
                                                <Image src={fewcloud}
                                                       alt="sun-cloud-icon"/> || description[0] === "Snow" &&
                                                <Image className="w-3/4" src={snow} alt="snow-icon"/>}
                                        </td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempday[0]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempnight[0]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><a href="@/pages/hava/Weather#"
                                                                       className={"font-medium text-blue-600 dark:text-blue-500 hover:underline"}>Saatlik</a>
                                        </td>
                                    </tr>
                                    <tr className={"border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700"}>
                                        <th scope="row"
                                            className={"px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"}>{dates[1]}</th>
                                        <td className={"px-6 py-4"}>{description[1] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[1] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[1] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[1] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[1] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[1] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[1] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[1] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempday[1]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempnight[1]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><a href="@/pages/hava/Weather#"
                                                                       className={"font-medium text-blue-600 dark:text-blue-500 hover:underline"}>Saatlik</a>
                                        </td>
                                    ...
                                    <tr className={"bg-white border-b dark:bg-gray-900 dark:border-gray-700"}>
                                        <th scope={"row"}
                                            className={"px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"}>{dates[2]}</th>
                                        <td className={"py-4 px-6"}>{description[2] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[2] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[2] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[2] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[2] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[2] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[2] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[2] === "Snow" &&
                                        ...
                                        <td className={"py-4 px-6"}><span
                                            className="font-medium text-2xl">{tempday[2]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"py-4 px-6"}><span
                                            className="font-medium text-2xl">{tempnight[2]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"py-4 px-6"}><a href="@/pages/hava/Weather#"
                                                                       className={"font-medium text-blue-600 dark:text-blue-500 hover:underline"}>Saatlik</a>
                                        </td>
                                    </tr>
                                    <tr className={"border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700"}>
                                        <th scope={"col"}
                                            className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{dates[3]}</th>
                                        <td className={"px-6 py-4"}>{description[3] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[3] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[3] === "moderate rain" &&
                                            <Image src={moderaterain}
                                                   alt='rain-cloud-icon'/> || description[3] === "heavy intensity rain" &&
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[3] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[3] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[3] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[3] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[3] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempday[3]}<span/><span
                                            className='align-top'>&deg;C</span></span></td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempnight[3]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><a href="@/pages/hava/Weather#"
                                                                       className={"font-medium text-blue-600 dark:text-blue-500 hover:underline"}>Saatlik</a>
                                        </td>
                                    ...
                                    <tr className={"bg-white border-b dark:bg-gray-900 dark:border-gray-700"}>
                                        <th scope={"col"}
                                            className={"px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"}>{dates[4]}</th>
                                        <td className={"px-6 py-4"}>{description[4] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[4] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[4] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[4] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[4] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[4] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[4] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[4] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempday[4]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempnight[4]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><a href="@/pages/hava/Weather#"
                                                                       className={"font-medium text-blue-600 dark:text-blue-500 hover:underline"}>Saatlik</a>
                                        </td>
                                    ...
                                    <tr className={"border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700"}>
                                        <th scope={"col"}
                                            className={"px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"}>{dates[5]}</th>
                                        <td className={"px-6 py-4"}>{description[5] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[5] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[5] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[5] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[5] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[5] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[5] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[5] === "Snow" &&
                                        ...
                                        <td className={"px-6 py-4"}><span
                                            className="font-meidum text-2xl">{tempday[5]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempnight[5]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><a href="@/pages/hava/Weather#"
                                                                       className={"font-medium text-blue-600 dark:text-blue-500 hover:underline"}>Saatlik</a>
                                        </td>
                                        ...
                                        <td className={"px-6 py-4"}>
                                            {description[6] === "sky is clear" &&
                                                ...
                                                <Image src={heavyrain}
                                                       alt='rain-cloud-icon'/> || description[6] === "overcast clouds" &&
                                                <Image src={cloud}
                                                       alt="cloud-sun"/> || description[6] === "broken clouds" &&
                                                <Image src={midcloud}
                                                       alt="cloud-sun"/> || description[6] === "scattered clouds" &&
                                                <Image src={fewcloud} alt="sun"/> || description[6] === "few clouds" &&
                                                <Image src={fewcloud}
                                                       alt="sun-cloud-icon"/> || description[6] === "Snow" &&
                                                <Image className="w-3/4" src={snow} alt="snow-icon"/>}
                                        </td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempday[6]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className={"px-6 py-4"}><span
                                            className="font-medium text-2xl">{tempnight[6]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className={"font-medium text-blue-600 dark:text-blue-500 hover:underline"}>Saatlik</a>
                                        </td>
                                    ...
                                    <tr className={"border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700"}>
                                        <th scope={"col"}
                                            className={"px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"}>{dates[7]}</th>
                                        <td className={"px-6 py-4"}>{description[7] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[7] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[7] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[7] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[7] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[7] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[7] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[7] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[7]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[7]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className={"font-medium text-blue-600"}>Saatlik</a>
                                        </td>
                                    </tr>
                                    <tr className="dark:bg-gray-900 dark:border-gray-700 bg-white border-b dark:bg-gray-900">
                                        ...
                                        <td className={"px-6 py-4"}>{description[8] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[8] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[8] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[8] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[8] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[8] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[8] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[8] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[8]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[8]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
                                    </tr>
                                    <tr className="dark:bg-gray-800 border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className={"px-6 py-4"}>{description[9] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[9] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[9] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[9] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[9] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[9] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[9] === "few clouds" &&
                                            <Image src={fewcloud} alt="sun-cloud-icon"/> || description[9] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[9]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[9]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
                                    ...
                                    <tr className="dark:bg-gray-900 dark:border-gray-700 bg-white border-b dark:bg-gray-900">
                                        ...
                                        <td className={"px-6 py-4"}>{description[10] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[10] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[10] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[10] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[10] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[10] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[10] === "few clouds" &&
                                            <Image src={fewcloud}
                                                   alt="sun-cloud-icon"/> || description[10] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[10]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[10]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
                                    ...
                                    <tr className="dark:bg-gray-800 border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className={"px-6 py-4"}>{description[11] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[11] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[11] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[11] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[11] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[11] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[11] === "few clouds" &&
                                            <Image src={fewcloud}
                                                   alt="sun-cloud-icon"/> || description[11] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[11]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[11]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
                                    ...
                                    <tr className="dark:bg-gray-900 dark:border-gray-700 bg-white border-b dark:bg-gray-900">
                                        ...
                                        <td className={"px-6 py-4"}>{description[12] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[12] === "light rain" &&
                                            <Image src={lightrain}
                                            ...
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[12] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[12] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[12] === "few clouds" &&
                                            <Image src={fewcloud}
                                                   alt="sun-cloud-icon"/> || description[12] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[12]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[12]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
                                    ...
                                    <tr className="dark:bg-gray-800 border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className={"px-6 py-4"}>{description[1] === "sky is clear" &&
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[13] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[13] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[1] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[13] === "few clouds" &&
                                            <Image src={fewcloud}
                                                   alt="sun-cloud-icon"/> || description[13] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[13]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[13]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
                                    ...
                                    <tr className="dark:bg-gray-900 dark:border-gray-700 bg-white border-b dark:bg-gray-900">
                                        ...
                                        <td className={"px-6 py-4"}>{description[14] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[14] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[14] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={heavyrain}
                                                   alt='rain-cloud-icon'/> || description[14] === "overcast clouds" &&
                                            <Image src={cloud}
                                                   alt="cloud-sun"/> || description[14] === "broken clouds" &&
                                            <Image src={midcloud}
                                                   alt="cloud-sun"/> || description[14] === "scattered clouds" &&
                                            <Image src={fewcloud} alt="sun"/> || description[14] === "few clouds" &&
                                            <Image src={fewcloud}
                                                   alt="sun-cloud-icon"/> || description[14] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[14]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[14]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
                                    ...
                                    <tr className="dark:bg-gray-800 border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className={"px-6 py-4"}>{description[15] === "sky is clear" &&
                                            <Image src={sun} alt='sun-icon'/> || description[15] === "light rain" &&
                                            <Image src={lightrain}
                                                   alt='rain-cloud-sun-icon'/> || description[15] === "moderate rain" &&
                                            <Image src={moderaterain}
                                            ...
                                            <Image src={fewcloud} alt="sun"/> || description[15] === "few clouds" &&
                                            <Image src={fewcloud}
                                                   alt="sun-cloud-icon"/> || description[15] === "Snow" &&
                                            <Image className="w-3/4" src={snow} alt="snow-icon"/>}</td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempday[15]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><span
                                            className="font-medium text-2xl">{tempnight[15]}</span><span
                                            className="align-top">&deg;C</span></td>
                                        <td className="px-6 py-4"><a href="@/pages/hava/Weather#"
                                                                     className="font-medium text-blue-500 hover:underline">Saatlik</a>
                                        </td>
