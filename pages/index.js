...
export default function Home() {
  ...
  // navigate(`/weather/${encodeURIComponent(response.data[0].name)}`);
              ...
              <Head>
                ...
                <nav className="bg-gradient-to-b from-gray-800 to-gray-600">
                  <div className="flex justify-start py-8">
                        <button type="button" className="ml-4 lg:hidden md:hidden relative inline-flex items-center justify-start rounded-md pr-8 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
